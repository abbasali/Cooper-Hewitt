...
<?php
	...
	$width = variable_get("droktabs_width", 232);
		...
		<div class="roktabs-links">
			<ul class="roktabs-top">
				...
				<?php while ($anode = db_fetch_object($result)) : ?>
					<li class="<?php if($count == 1): ?>first active<?php elseif($count == $limitnum): ?>last<?php endif; ?>"><span><?php echo $anode->title; ?></span></li>
					<?php $count++; ?>
				<?php endwhile; ?>
			</ul>
		</div>
			...
			<div class="roktabs-container-wrapper">
				...
				<div class="roktabs-tab<?php echo $count2; ?>">
					<div class="wrapper">
						...
						<?php 
							$thisString = $anode2->body;
							$imgpath = base_path() . path_to_theme();
							$final_text = str_replace("<?php echo base_path() . path_to_theme(); ?>", $imgpath, $thisString);
							echo $final_text;
