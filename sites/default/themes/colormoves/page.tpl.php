...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<?php
			$pageclass = "";
			if($is_front) {$pageclass="colormoves-home";}
		...
		<?php
			if (isset($_GET['tstyle']) ) {
				...
				colormoves_change_theme($change, $styleVar);
			}
		?>
...
<script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script><script type="text/javascript">stLight.options({publisher:'808fd4d2-4b3f-457d-afda-337d5e5aa268'});</script>
	...
	<body id="ff-<?php echo $colormoves_font_family; ?>" class="f-<?php echo $colormoves_defaultfont; ?> <?php echo $colormoves_preset_style; ?> <?php echo $colormoves_bg_style; ?> <?php echo $pageclass; ?> iehandle">
			...
			<div class="padding">
				...
				<div class="logo-module">
					...
					<?php elseif (theme_get_setting(show_logo)) : ?>
						<a href="http://cooperhewitt.org" id="logo-link"><a href="http://beta.cooperhewitt.org/microsites/set-in-style/" id="logo"></a></a>
					<?php endif; ?>
				</div>
				<?php endif; ?>
				<!--End Logo-->
	...
	<div class="wrapper">
		...
		<?php if($colormoves_menu_type != "none") : ?>
		<div id="horiz-menu" class="<?php echo $colormoves_menu_type; ?>">
			<div class="wrapper">
				<div class="padding">
					<div id="horizmenu-surround">
					<?php if($colormoves_menu_type != "module") : ?>
						<?php
							$tree = menu_tree_page_data('menu-colormoves');  
			        ...
			        <div class="colmid">
			    	    <div class="colright">
					       <!--Begin Main Column (col1wrap)-->   
						    ...
						    <div class="col2">
								<div id="leftcol">
									<?php if ($colormoves_menu_type == "splitmenu" and theme_get_setting(splitmenu_col) == "leftcol" and !$is_front) : ?>
						    ...
						    <div class="col3">
								<div id="rightcol">
									<?php if ($colormoves_menu_type == "splitmenu" and theme_get_setting(splitmenu_col) == "rightcol" and !$is_front) : ?>
