...
<link href="<?php echo base_path() . path_to_theme(); ?>/css/<?php echo $colormoves_preset_style; ?>.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_path() . path_to_theme(); ?>/css/typography.css" rel="stylesheet" type="text/css" />

<link href="<?php echo base_path() . path_to_theme(); ?>/css/menu-<?php echo $colormoves_menu_type; ?>.css" rel="stylesheet" type="text/css" />
...
<style type="text/css">
	...
	a, #top-right ul li a:hover, .abstract-menu li a:hover, #main-content .cart_totals div, #roksearch_results .roksearch_odd-hover h3, #roksearch_results .roksearch_even-hover h3, #horiz-menu.splitmenu li:hover .item span, #horiz-menu.splitmenu li.active .item span, #horiz-menu.splitmenu li.active:hover .item span {color: <?php echo $colormoves_link_color; ?>}
	#main-body ul.menu li > a, #main-body ul.menu li > .separator, #main-body ul.menu li > .item, #main-body ul.menu li li > a, #main-body ul.menu li li > .separator, #main-body ul.menu li li > .item, .feature-block a .readon1-r {color: <?php echo $colormoves_link_color; ?>}	
	.pagination .page-active, .pagination .page-inactive:hover, .rokstories-layout4 .feature-block .feature-number-sub.active {background: <?php echo $colormoves_link_color; ?>}
...
<link href="<?php echo base_path() . path_to_theme(); ?>/css/<?php echo $colormoves_preset_style; ?>_ie6.css" rel="stylesheet" type="text/css" />
