...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<?php
			$pageclass = "";
			if($is_front) {$pageclass="nda-home";}
		...
		<?php
			if (isset($_GET['tstyle']) ) {
				...
				nda_change_theme($change, $styleVar);
			}
		?>
	...
	<body id="ff-<?php echo $nda_font_family; ?>" class="f-<?php echo $nda_defaultfont; ?> <?php echo $nda_preset_style; ?> <?php echo $nda_bg_style; ?> <?php echo $pageclass; ?> iehandle">
	...
	<div class="wrapper">
		...
		<?php if($nda_menu_type != "none") : ?>
		<div id="horiz-menu" class="<?php echo $nda_menu_type; ?>">
			<div class="wrapper">
				<div class="padding">
					<div id="horizmenu-surround">
					<?php if($nda_menu_type != "module") : ?>
						<?php
			        ...
			        <div class="colmid">
			    	    <div class="colright">
					       <!--Begin Main Column (col1wrap)-->   
						    ...
						    <div class="col2">
								<div id="leftcol">
									<?php if ($nda_menu_type == "splitmenu" and theme_get_setting(splitmenu_col) == "leftcol" and !$is_front) : ?>
						    ...
						    <div class="col3">
								<div id="rightcol">
									<?php if ($nda_menu_type == "splitmenu" and theme_get_setting(splitmenu_col) == "rightcol" and !$is_front) : ?>
