<?php
	...
	if(((theme_get_setting(splitmenu_col) == "leftcol") and $setinstyle_menu_type == "splitmenu" AND $thisTitle != "" and !$is_front) or $left) {
	...
	if(((theme_get_setting(splitmenu_col) == "rightcol") and $setinstyle_menu_type == "splitmenu" AND $thisTitle != "" and !$is_front) or $right) {
